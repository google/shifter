...
docker image rm --force local.shifter.cloud/shifter-ui:latest
docker image rm --force local.shifter.cloud/shifter:latest
# Building Local Development Images for Shifter UI and Shifter Server
docker build  --no-cache -t local.shifter.cloud/shifter-ui:latest -f "./shifter-ui/Dockerfile" ./shifter-ui/
docker build  --no-cache -t local.shifter.cloud/shifter:latest -f "./shifter/Dockerfile" ./shifter/
