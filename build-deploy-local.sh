...
docker container rm -f shifter_nginx
...
docker image rm --force local.images.shifter.cloud/shifter-nginx:latest
...
docker build  --no-cache -t local.images.shifter.cloud/shifter-nginx:latest -f "./shifter-ui/nginx/Dockerfile" ./shifter-ui/nginx/
