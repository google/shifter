<template>
  <div
    class="z-50 float absolute bg-shifter-red-soft flex items-center justify-center h-screen w-screen"
  >
    <!-- LOADING SELECTION -->
    <div class="container flex-row mx-auto justify-center py-12">
      <div class="container flex-row justify-center items-center">
        <div
          class="flex justify-center text-shifter-black-soft bold text-4xl m-2"
        >
          {{ getTitle }}
        </div>
...
export default {
  computed: {
    ...mapState(useConfigurationsLoading, {
      getTitle: "getTitle",
    }),
    ...mapState(useConfigurationsLoading, {
