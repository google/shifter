...
<template>
  ...
  >
    <div
      class="container flex absolute items-center w-1/2 h-1/2 bg-shifter-black-soft border rounded-2xl overflow-y-auto"
    >
      <div class="container flex flex-col mx-auto w-full gap-5">
        <div class="container flex flex-row mx-auto w-full justify-center">
          <div class="flex flex-row text-xl text-center font-bold">
            Create New OpenShift Cluster Configuration
          </div>
        </div>
        <div
          class="container flex flex-col mx-auto w-full text-xl gap-5 justify-center"
        >
            ...
            <div class="flex flex-row my-2">
              ...
              <div class="w-4/6 overflow-x-auto">
                <input
                  type="text"
                  class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-shifter-black-soft bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                  placeholder="[HTTP|S]://[DOMAIN-NAME].com:[PORT]"
            ...
            <div class="flex flex-row my-2 grow-0">
              ...
              <div class="w-4/6 overflow-x-auto">
                <textarea
                  class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-shifter-black-soft bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                  rows="3"
                  placeholder="Openshift Bearer Token"
