...
###################### Mandatory Vairables ##########################
PROJECT_ID=$1                    #e.g. : "pm-okd-11"
CLUSTER_NAME=$2                  #e.g. : "okd-41"
OKD_VERSION=$3                   #e.g. : "4.10" or "4.9"
BILLING_ACCOUNT_ID=$4            #e.g. : "xxxxxx-yyyyyy-zzzzzz"
PARENT=$5                        #e.g. : "organizations/111222333444"
DOMAIN=$6                        #e.g. : "google.com."
